...
/*   Updated: 2025/04/10 17:34:56 by dancel           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{std::cout << other.getname() << " is duplicate" << std::endl;}
...
ClapTrap	&ClapTrap::operator=(const ClapTrap &other)
{
	...
	{{std::cout << this->getname() << " is replaced by " << other.getname() << std::endl;}}
	this->setname(other.getname());
	return (*this);
}

ClapTrap::~ClapTrap()
{std::cout << this->getname() << " is deconstructed" << std::endl;}
