...
/*   Updated: 2025/04/10 19:38:10 by dancel           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void 	ClapTrap::attack(const std::string& target)
{
	if (this->getenergy() > 0 && this->gethit() > 0)
	{
		...
		std::cout << this->getname() << " the ClapTrap attacks " << target << " causing " << this->getattack() << " points of damage !" << std::endl;
	}
	else
		std::cout << this->getname() << " the ClapTrap can't attacks !" << std::endl;
}
